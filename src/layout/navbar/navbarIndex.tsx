...
{""}
{options?.map((child, i) => {
                    const { color, icon, label, description } = child;
                    return (
                      <div 
                      onMouseEnter={() => handleMouseEnter(i)}
                      onMouseLeave={handleMouseLeave}
                      className={`drop-box ${activeIndex === i ? 'active' : ''}`} // Add 'active' class on hover
                  ...
                  <>
                    <div className="blog-learn-box">
                        ...
                        <p className="link">Our Blog<span><figure>{navbarIcons.arowUp}</figure></span></p>
